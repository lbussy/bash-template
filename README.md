...
These functions serve as an example of how you can build upon the script with your own functionality.
...
This example has up to three arguments, plus the optional debug argument:
